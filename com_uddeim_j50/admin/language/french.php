...
DEFINE ('_UDDEIM_TODP_TITLE_CC0', ' (virgule pour séparer)');
DEFINE ('_UDDEIM_TODP_TITLE_CC1', ' (point-virgule pour séparer)');
...
DEFINE ('_UDDEIM_PM_USER', 'Envoyer un message privé');
DEFINE ('_UDDEIM_PM_USER_DESC', 'Envoyer un message privé à cet utilisateur');
DEFINE ('_UDDEIM_PM_INBOX', 'Afficher la boîte de réception privée');
DEFINE ('_UDDEIM_MENU_PM_INBOX_DESC', 'Afficher les messages privés reçus');
DEFINE ('_UDDEIM_PM_OUTBOX', 'Afficher la boîte d\'envoi privée');
DEFINE ('_UDDEIM_MENU_PM_OUTBOX_DESC', 'Afficher les messages privés envoyés');
DEFINE ('_UDDEIM_PM_TRASHBOX', 'Afficher la corbeille');
DEFINE ('_UDDEIM_MENU_PM_TRASHBOX_DESC', 'Afficher les messages privés supprimés');
DEFINE ('_UDDEIM_PM_OPTIONS', 'Afficher les options PMS');
DEFINE ('_UDDEIM_MENU_PM_OPTIONS_DESC', 'Afficher les options PMS');
DEFINE ('_UDDEIM_PM_ARCHIVE',' Messsages archivés');
DEFINE ('_UDDEIM_PM_ARCHIVE_DESC', 'Afficher les messages archivés');
DEFINE ('_UDDEIM_PM_SENDMESSAGE', 'Message envoyé');
DEFINE ('_UDDEIM_PMSTAB', 'Envoyer un message');
DEFINE ('_UDDEIM_PM_PROFILEMSG', 'Message rapide');
DEFINE ('_UDDEIM_PM_SENTSUCCESS', 'Envoyé avec succès');
DEFINE ('_UDDEIM_PM_SESSIONTIMEOUT', 'Expiration de la session.');
DEFINE ('_UDDEIM_PM_NOTSENT', 'Message non envoyé.');
DEFINE ('_UDDEIM_PM_TRYAGAIN', 'Réessayer.');
...
DEFINE ('_UDDEIM_PM_TABINBOX', 'Boîte de réception');
DEFINE ('_UDDEIM_PM_PMSLINK', 'Messagerie privée');
...
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Spécifiez le service Captcha que vous souhaitez utiliser: Service intégré ou reCaptcha (infos <a href="https://www.google.com/recaptcha/about/" target="_new">reCaptcha</a>)');
