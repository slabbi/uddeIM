...
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_0', 'ein Update benötigt config v2.6 oder größer');
...
DEFINE ('_UDDEADM_AUTOCOMPLETER_0', 'nicht laden');
...
DEFINE ('_UDDEADM_SEP', ' [Komma]');
DEFINE ('_UDDEADM_SEP1', ' [Strichpunkt]');
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'Ein oder mehrere Empfängernamen');
DEFINE ('_UDDEIM_TODP_TITLE_CC0', ' (durch Komma getrennt)');
DEFINE ('_UDDEIM_TODP_TITLE_CC1', ' (durch Strichpunkt getrennt)');
DEFINE ('_UDDEIM_DOREPLY', 'antworten');
...
DEFINE ('_UDDEIM_PM_USER', 'Private Nachricht senden');
DEFINE ('_UDDEIM_PM_USER_DESC', 'Diesem Benutzer eine private Nachricht senden');
...
DEFINE ('_UDDEIM_PM_SENDMESSAGE', 'Nachricht senden');
...
DEFINE ('_UDDEIM_FILTER_TITLE_POSTBOX', 'Zeige Nachrichten VON und AN diesen Benutzer');
DEFINE ('_UDDEIM_MESSAGES', 'Nachrichten');
DEFINE ('_UDDEIM_POSTBOX', 'Unterhaltungen');
DEFINE ('_UDDEIM_FILTEREDUSER', 'Unterhaltung gefiltert');
DEFINE ('_UDDEIM_FILTEREDUSERS', 'Unterhaltungen gefiltert');
...
DEFINE ('_UDDEIM_HELP_PFLAGGED', 'Eine Nachricht wurde markiert, z.B. wenn es sich um eine wichtige Nachricht handelt <br>&emsp;&emsp;(der Status kann <b>in der Unterhaltung</b> geändert werden).');
DEFINE ('_UDDEIM_HELP_PUNFLAGGED', '<i>Normale</i> Nachricht (der Status kann <b>in der Unterhaltung</b> geändert werden).');
DEFINE ('_UDDEIM_HELP_PATTACHMENT', 'eine Nachricht enthält einen Dateianhang.');
DEFINE ('_UDDEIM_HELP_PDELETE', 'Unterhaltung bzw. Nachricht löschen (&rarr; in den Papierkorb verschieben).');

// New: 2.7
DEFINE ('_UDDEADM_MOOTOOLS_NONEMEIO', 'MEIO explizit laden');
DEFINE ('_UDDEADM_MOOTOOLS_13MEIO', 'verwende MEIO mit MooTools 1.3');
...
DEFINE ('_UDDEIM_FILTER_UNREAD', 'ungelesen');
DEFINE ('_UDDEIM_FILTER_FLAGGED', 'wichtig');
...
DEFINE ('_UDDEADM_CRYPT4', 'OpenSSL mit Passwort');
...
DEFINE ('_UDDEIM_HELP_ARCHIVE', 'Das <b>Archiv</b> beinhaltet alle archivierten Nachrichten. Es können nur gesendete Nachrichten archiviert werden. Wenn eine selbstgeschriebene Nachricht archiviert werden soll, die Nachricht mit <i>Kopie an mich</i> versenden.');
...
DEFINE ('_UDDEIM_HELP_FLAGGED', 'Die Nachricht wurde markiert, z.B. wenn es sich um eine wichtige Nachricht handelt <br>&emsp;&emsp;(der Status kann durch Mausklick geändert werden).');
...
DEFINE ('_UDDEIM_HELP_RECYCLE', 'Nachricht wiederherstellen (die Nachricht wird aus dem Papierkorb wieder zur Unterhaltung verschoben).');
...
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Hinweis:<br />Wenn JoomlaMail verwendet wird, sollte hier unbedingt eine korrekte E-Mail Adresse angegeben werden!</b>');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' ungelesenen');
...
// New: 1.3
DEFINE ('_UDDEADM_MOOTOOLS_HEAD', 'Autocompleter (MEIO)');
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'Wie soll uddeIM die Autocompleter Funktion laden: <i>Nicht laden</i> = keine Funktion.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE', 'MEIO nicht laden');
...
DEFINE ('_UDDEIM_STATUS_UNFLAGGED','als Wichtig markieren');
...
DEFINE ('_UDDEADM_REVIEWEMAILSTOP', 'Nach der Installation ist der Versandt von E-Mails aus uddeIM gesperrt (E-Mail Benachrichtigungen, Forgetmenot E-Mails), so dass keine E-Mails versendet werden, solange Sie noch testen. Vergessen Sie nicht "E-Mail Stopp" im Backend zu deaktivieren, wenn Sie mit dem Testen fertig sind.');
...
DEFINE ('_UDDEADM_MAILSYSTEM_MOSMAIL', 'wie Joomla Mail');
...
DEFINE ('_UDDEADM_USEAUTOCOMPLETE_HEAD', 'Empfängernamen vorschlagen');
DEFINE ('_UDDEADM_USEAUTOCOMPLETE_EXP', 'Namen von Nachrichtenempfängern vorschlagen / vervollständigen.');
...
DEFINE ('_UDDEMODULE_NEWMESSAGES', '<b>neue</b> Nachrichten');
...
DEFINE ('_UDDEADM_CRYPT1', 'einfach verschlüsseln');
DEFINE ('_UDDEADM_CRYPT2', 'Verschlüsseln mit Passwort');
...
DEFINE ('_UDDEIM_FROM_IN', 'Nachricht von');
DEFINE ('_UDDEIM_FROM', 'Unterhaltung mit');
DEFINE ('_UDDEIM_FROM_SMALL', 'von');
DEFINE ('_UDDEIM_TO', 'Nachricht an');
...
DEFINE ('_UDDEADM_DELETIONS', 'Bereinigung');
...
DEFINE ('_UDDEIM_EMN_SUBJECT', 'neue Nachrichten auf %site%');
...
DEFINE ('_UDDEIM_ARC_SAVED_NONE_2', 'es befinden sich keine Nachrichten im Archiv.');
