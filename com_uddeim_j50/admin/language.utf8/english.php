...
DEFINE ('_UDDEADM_CONFIGNOTE', 'NOTE: because of Cache settings changes may not be visible after save and reload');
DEFINE ('_UDDEADM_KUNENA6', 'Kunena 6.0+');
DEFINE ('_UDDEADM_KUNENA5', 'Kunena 5.0+');
DEFINE ('_UDDEADM_AUTOCOMPLETER_0', 'do not load');
DEFINE ('_UDDEADM_AUTOCOMPLETER_1', 'JS W3, case-insensitve');
DEFINE ('_UDDEADM_AUTOCOMPLETER_2', 'JS light, case-sensitive');
DEFINE ('_UDDEADM_AUTOCOMPLETER_3', 'Uddeim JS, look inside name');
DEFINE ('_UDDEADM_AUTOCOMPLETER_EXP', '(<b>use autocomplete</b> must be activated)<br><i>do not load</i> no autocompleter function.<br>W3 - case-<b>insensitive</b>, <b>multiple</b> input.<br>light - case-<b>sensitive</b>');
DEFINE ('_UDDEADM_AUTOCOMPLETER_HEAD', 'Autocompleter');
DEFINE ('_UDDEADM_AUTOCOMPLETESTART_HEAD', 'start at letter');
DEFINE ('_UDDEADM_AUTOCOMPLETESTART_EXP', 'number of letters to start autocompleter');
DEFINE ('_UDDEADM_SEPERROR', 'required seperator for multiple names is ');
DEFINE ('_UDDEADM_SEP', ' [comma]');
DEFINE ('_UDDEADM_SEP1', ' [semicolon]');
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'One or more recipients');
DEFINE ('_UDDEIM_TODP_TITLE_CC0', ' (comma separated)');
DEFINE ('_UDDEIM_TODP_TITLE_CC1', ' (semicolon separated)');
DEFINE ('_UDDEIM_DOREPLY', 'Reply');
...
// New: 2.7
DEFINE ('_UDDEADM_MOOTOOLS_NONEMEIO', 'load MEIO explicit');
DEFINE ('_UDDEADM_MOOTOOLS_13MEIO', 'use MEIO with MooTools 1.3 ');
...
DEFINE ('_UDDEADM_CAPTCHA_INTERNAL', 'Uddeim grafical code');
DEFINE ('_UDDEADM_CAPTCHA_RECAPTCHA', 'reCaptcha');
DEFINE ('_UDDEADM_CAPTCHATYPE_HEAD', 'Captcha service');
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Which captcha service do you want to use: The build-in service or reCaptcha (see <a href="https://www.google.com/recaptcha/about/" target="_new">reCaptcha</a> for more information)?<br><b>NUM=</b> math. question plus hidden field (robot protection)'); 
...
DEFINE ('_UDDEADM_CRYPT4', 'OpenSSL and password');
...
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Note:<br />When using Joomla Mail, you have to configure a valid email address!</b>');
...
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'This specifies how uddeIM loads Autocompleter Function: <i>do not load</i> no autocomleter function.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE', 'do not load MEIO');
...
DEFINE ('_UDDEMODULE_NONEW', 'No new messages');
...
DEFINE ('_UDDEADM_CRYPT2', 'Encrypt with password');
...
DEFINE ('_UDDEIM_FROM', 'Conversation with');
DEFINE ('_UDDEIM_FROM_IN', 'Message from');
DEFINE ('_UDDEIM_FROM_SMALL', 'from');
DEFINE ('_UDDEIM_TO', 'Message to');
