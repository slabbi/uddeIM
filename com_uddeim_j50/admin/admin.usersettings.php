...
function uddeIMshowUsersettings($option, $task, $act, $config) {
	...
	<tr>
        ...
        <?php echo $pageNav->writeLimitBox('?option=$option&task=$task'); ?>
        </td>
...
<?php
	...
	echo mosHTML::selectList($moderated_items_arr, 'f_moderated', 'size="1" class="form-select"', 'value', 'text', $f_param[9]);
?>
		</td>
		<td>
<?php
	...
	echo mosHTML::selectList($locked_items_arr, 'f_locked', 'size="1" class="form-select"', 'value', 'text', $f_param[8]);
?>
		</td>
        <td>
<?php
	...
	echo mosHTML::selectList($id_items_arr, 'f_id', 'size="1" class="form-select"', 'value', 'text', $f_param[5]);
?>
		</td>
        </tr><tr>
		<td align="right">
<?php
	...
	echo mosHTML::selectList($popup_items_arr, 'f_popup', 'size="1" class="form-select"', 'value', 'text', $f_param[3]);
?>
		</td>
		<td>
<?php
	...
	echo mosHTML::selectList($public_items_arr, 'f_public', 'size="1" class="form-select"', 'value', 'text', $f_param[4]);
?>
		</td>
		<td>
<?php
	...
	echo mosHTML::selectList($autor_items_arr, 'f_autor', 'size="1" class="form-select"', 'value', 'text', $f_param[6]);
?>
		</td>
		<td>
<?php
	...
	echo mosHTML::selectList($autof_items_arr, 'f_autof', 'size="1" class="form-select"', 'value', 'text', $f_param[7]);
?>
		</td>
        <td colspan="2">
<?php
	...
	echo mosHTML::selectList($status_arr, 'f_status', 'size="1" class="form-select"', 'value', 'text', $f_param[2]);
?>
