...
@version 5.3
@copyright 2010 - 2024 Michal Prochaczek
@license GNU/GPL2
...
/**
 * Script file of uddeIM Simple Notifier module, for version 5.3.0
 */
class mod_uddeim_simple_notifierInstallerScript
{
	...
	function update($parent)
	{
		// $parent is the class calling this method
		//echo '<p>' . JText::_('MOD_UDDEIM_SIMPLE_XML_DESCRIPTION') . '</p>';
		echo '<p>' . Text::sprintf('MOD_UDDEIM_SIMPLE_UPDATE_TEXT', $parent->getManifest()->version) . '</p>';
	}
	/**
