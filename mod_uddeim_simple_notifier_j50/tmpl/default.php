...
//displays notification image      /index.php/profil/unterhaltung?task=inbox Route::_('index.php?option=com_uddeim&view=select&id=1')
if (($id) AND ($nomessages>0)) {
	echo '<a href="/index.php/profil/unterhaltung?task=inbox">' .
