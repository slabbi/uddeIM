<?php
/**
mod_uddeim_simple_notifier template file bootstrap3-button.php
update 2014-12-28
mod version 3.5
...
if (($id) AND ($nomessages>=0))
	{
		...
		if (($id) AND ($nomessages>0)) {
			echo '<img src="' . URI::root() . 'media/mod_uddeim_simple_notifier/icons/' .
			$IconImg . '" title="' . $LabelMessages . '" alt="' . $nomessages . '"/>&nbsp';
		}
