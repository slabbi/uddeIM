	...
	if ( $config->enablepostbox ) {
		...
		if ($uddeaction=="postbox") {
			...
			if ($config->showmenuicons==1 || $config->showmenuicons==2)
				echo "<img src='".$pathtosite."/components/com_uddeim/templates/".$config->templatedir."/images/menu_postbox.png' alt='"._UDDEIM_POSTBOX."' style='height:18px;' />";
			...
			if ($config->showmenuicons==1 || $config->showmenuicons==2)
				echo "<img src='".$pathtosite."/components/com_uddeim/templates/".$config->templatedir."/images/menu_postbox.png' border='0' alt='"._UDDEIM_POSTBOX."' style='height:18px;' />";
			if ($config->showmenuicons==0 || $config->showmenuicons==1)
				echo _UDDEIM_POSTBOX;
			echo $cnt;
			echo "</a>";
