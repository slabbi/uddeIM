...
?>
		<table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminForm" id="adminForm">
			...
			<?php uddeIMadmText($config->badwords, 30, 'config_badwords', false, _UDDEADM_BADWORDS_HEAD, _UDDEADM_BADWORDS_EXP); ?>
...
?>
		<table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminForm" id="adminForm">
			...
			<?php uddeIMadmText($config->recaptchapub, 30, 'config_recaptchapub', !$config->usecaptcha, _UDDEADM_RECAPTCHAPUB_HEAD, _UDDEADM_RECAPTCHAPUB_EXP); ?>
			<?php uddeIMadmText($config->recaptchaprv, 30, 'config_recaptchaprv', !$config->usecaptcha, _UDDEADM_RECAPTCHAPRV_HEAD, _UDDEADM_RECAPTCHAPRV_EXP); ?>
...
<?php				echo uddeIMprintCond(!$config->enableattachment, _UDDEADM_ATTACHMENTGROUPS_EXP, "gray", false); ?>
			...
			<?php uddeIMadmText($config->allowedextensions, 30, 'config_allowedextensions', !$config->enableattachment, _UDDEADM_ALLOWEDEXTENSIONS_HEAD, _UDDEADM_ALLOWEDEXTENSIONS_EXP); ?>
			<?php 
				$amatt = Array();
				$amatt['3'] = "3";
				$amatt['2'] = "2";
