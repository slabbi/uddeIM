...
global $configversion,$versionstring;
//$configversion	= "2.6";
...
<?php	
	...
	if (uddeIMcheckJversion()>=15) {	// only Joomla 3.0, bug (not) fixed in Joomla 3.1
...
?>
		<table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminForm" id="adminForm">
			<tr align="center" valign="middle">
				<td align="left" valign="top">
					<h2>uddeIM</h2>
					<?php echo "<p><span style='color: red;'>".($versionstring ?? 'uddeIM 5.0')."</span></p>\n"; ?>
