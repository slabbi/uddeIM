...
// New: 3.7
DEFINE ('_UDDEADM_SHOWMENULINK_HEAD', 'Zobrazit nabídku');
DEFINE ('_UDDEADM_SHOWMENULINK_EXP', 'Zobrazit další nabídku.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_16', '...nastavit jako defaultní pro další nabídku.');

// New: 3.6
DEFINE ('_UDDEIM_KUNENA_LINK', 'Fórum');
DEFINE ('_UDDEIM_PM_USER', 'Poslat soukromou zprávu');
DEFINE ('_UDDEIM_PM_USER_DESC', 'Poslat soukromou zprávu');
DEFINE ('_UDDEIM_PM_INBOX', 'Zobrazit Přijaté zprávy');
DEFINE ('_UDDEIM_PM_INBOX_DESC', 'Zobrazit přijaté soukromé zprávy');
DEFINE ('_UDDEIM_PM_OUTBOX', 'Zobrazit Odeslané zprávy');
DEFINE ('_UDDEIM_PM_OUTBOX_DESC', 'Zobrazit odeslané soukromé zprávy');
DEFINE ('_UDDEIM_PM_TRASHBOX', 'Zobrazit koš');
DEFINE ('_UDDEIM_PM_TRASHBOX_DESC', 'Zobrazit soukromé zprávy v koši');
DEFINE ('_UDDEIM_PM_OPTIONS', 'Zobrazit možnosti PMS');
DEFINE ('_UDDEIM_PM_OPTIONS_DESC', 'Zobrazit možnosti PMS');
DEFINE ('_UDDEIM_PM_ARCHIVE', 'Zobrazit Archiv zpráv');
DEFINE ('_UDDEIM_PM_ARCHIVE_DESC', 'Zobrazit archivované soukromé zprávy');
DEFINE ('_UDDEIM_PM_SENDMESSAGE', 'Zpráva odeslána');
DEFINE ('_UDDEIM_PM_PMSTAB', 'Poslat zprávu');
DEFINE ('_UDDEIM_PM_PROFILEMSG', 'Krátká zpráva');
DEFINE ('_UDDEIM_PM_SENTSUCCESS', 'Úspěšně odesláno.');
DEFINE ('_UDDEIM_PM_SESSIONTIMEOUT', 'Session vypršelo.');
DEFINE ('_UDDEIM_PM_NOTSENT', 'Zpráva neodeslána.');
DEFINE ('_UDDEIM_PM_TRYAGAIN', 'Zkus to znovu.');
DEFINE ('_UDDEIM_PM_EMPTYMESSAGE', 'Prázná zpráva.');
DEFINE ('_UDDEIM_PM_EMAILFORMSUBJECT', 'Předmět');
DEFINE ('_UDDEIM_PM_EMAILFORMMESSAGE', 'Zpráva');
DEFINE ('_UDDEIM_PM_TABINBOX', 'Přijaté');
DEFINE ('_UDDEIM_PM_PMSLINK', 'Soukromé zprávy');

// New: 3.5
DEFINE ('_UDDEADM_GROUPSADMIN_HEAD', 'Přidané skupiny Adminů ');
DEFINE ('_UDDEADM_GROUPSADMIN_EXP', 'Zadej ID skupin které by měly být označeny jako skupiny administrátorů (např. 10, 11, 17). ID č. 7, 8 (Joomla >=1.6) a ID č. 24, 25 (Joomla <=1.5) jsou vždy admini.');
DEFINE ('_UDDEADM_GROUPSSPECIAL_HEAD', 'Přidané speciální skupiny');
DEFINE ('_UDDEADM_GROUPSSPECIAL_EXP', 'Zadej ID skupin které by měly být označeny jako speciální skupiny (např. 10, 11, 17). ID č. 3-8 (Joomla >=1.6) a ID č. 19-25 (Joomla <=1.5) jsou vždy uživatelé spec.skupin.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_15', '...nastavit jako defaultní pro přidávané skupiny');
